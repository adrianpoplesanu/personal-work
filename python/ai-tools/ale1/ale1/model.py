"""Decoder-only Transformer (character-level GPT)."""
...
class CausalSelfAttention(nn.Module):
    def __init__(self, n_embd: int, n_head: int, block_size: int, dropout: float) -> None:
        ...
        # causal mask: lower triangular (include diagonal)
...
class GPT(nn.Module):
    """Small GPT: token + position embeddings, transformer blocks, LM head."""
    ...
    def generate(
        ...
        """Autoregressive sampling from next-token probabilities."""
